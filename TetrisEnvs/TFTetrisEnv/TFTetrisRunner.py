...
class TFTetrisRunner:
    def __init__(self, queue_size, max_holes, max_len, num_steps, num_envs, p_model, v_model, seed=[0, 0]):
    ...
    def _single_step(self, t, board, pieces, all_boards, all_pieces, all_actions, all_log_probs,
                     all_values, all_attacks, all_height_penalty, all_hole_penalty,
                     all_skyline_penalty, all_bumpy_penalty, all_death_penalty, all_dones):
        ...
        return (t + 1, new_board, new_pieces, all_boards, all_pieces, all_actions, all_log_probs,
                all_values, all_attacks, all_height_penalty, all_hole_penalty,
                all_skyline_penalty, all_bumpy_penalty, all_death_penalty, all_dones)
    ...
    def collect_trajectory(self):
        ...
        (t, board, pieces, all_boards, all_pieces, all_actions, all_log_probs,
         all_values, all_attacks, all_height_penalty, all_hole_penalty,
         all_skyline_penalty, all_bumpy_penalty, all_death_penalty, all_dones) = tf.while_loop(
            lambda t, nb, np, ab, ap, aa, alp, av, aat, ahp, ahop, asp, abp, adp, ad: t < self._num_steps,
            self._single_step,
